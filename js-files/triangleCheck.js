...
function triangleCheck() {
    ...
    if (angle1.value === "" || angle2.value === "" || angle3.value === "") {
        triangleCheckOutput.innerText =
            "Fill in all the values correctly first.";
        ...
        triangleCheckOutput.innerText = "Yes!! These angles form a triangle!";
    } else if (totalAngle !== 180) {
        triangleCheckOutput.innerText =
            "Oops!! These angles do not form a triangle!";
    }
}
